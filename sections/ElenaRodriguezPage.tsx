...
const ELENA_RODRIGUEZ_BUILDER: Builder = {
  ...
  fullBio: "Elena is a senior AI product manager with over 7 years of experience in AI strategy and implementation. She has successfully scaled AI products at Fortune 500 companies, leading cross-functional teams of engineers, designers, and data scientists. Elena specializes in translating business requirements into technical solutions and ensuring AI products deliver measurable value.",
  experienceLevel: "Senior",
  isL1Certified: false,
  location: "Austin, TX",
  skills: ["Product Strategy", "MLOps", "Kubernetes", "DataDog", "Jira", "Figma", "A/B Testing", "User Research"],
  certifications: ["Product Management", "Agile Certified", "AI Strategy"],
  socialLinks: {
    linkedin: "https://linkedin.com/in/elena-rodriguez",
    github: "https://github.com/elena-rodriguez",
    website: "https://elena-rodriguez.dev",
